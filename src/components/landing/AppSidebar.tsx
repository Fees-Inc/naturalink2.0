...
const navigation = [
  ...
  { name: "Utilisateurs", href: "/users", icon: Users, badge: "250" },
  { name: "Produits", href: "/products", icon: Package, badge: "35" },
  { name: "Producteurs", href: "/producers", icon: Wheat, badge: null },
  { name: "Distributeurs", href: "/distributors", icon: Building2, badge: null },
  { name: "Blockchain", href: "/blockchain", icon: Link, badge: "1450" },
  { name: "Analytics", href: "/analytics", icon: BarChart3, badge: null },
  { name: "Marketing", href: "/marketing", icon: Megaphone, badge: "3" },
        ...
        <div className="p-4 border-t border-sidebar-border">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground">admin@naturalink.com</p>
            </div>
